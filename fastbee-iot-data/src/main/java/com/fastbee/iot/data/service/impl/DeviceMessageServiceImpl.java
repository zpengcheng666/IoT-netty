...
//        DeviceAndProtocol deviceAndProtocol = deviceService.selectProtocolBySerialNumber(serialNumber);
        ...
        if (!(FastBeeConstant.PROTOCOL.ModbusRtu.equals(deviceProtocolDetail.getProtocolCode()) || FastBeeConstant.PROTOCOL.ModbusTcpOverRtu.equals(deviceProtocolDetail.getProtocolCode())
                || FastBeeConstant.PROTOCOL.ModbusTcp.equals(deviceProtocolDetail.getProtocolCode()))) {
        ...
        if (type  == 1){
            ...
            if (FastBeeConstant.PROTOCOL.ModbusTcp.equals(deviceProtocolDetail.getProtocolCode())) {
            ...
            if (FastBeeConstant.PROTOCOL.ModbusTcpOverRtu.equals(deviceProtocolDetail.getProtocolCode())) {
