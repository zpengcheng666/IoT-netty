package com.fastbee.rule.parser.bus;//package com.ming.core.parser.bus;
//
...
//    }
//
////    public static FinallyELWrapper node(Node node){
////        FinallyELWrapper wrapper = new FinallyELWrapper(node.getFinallyEL());
////        setId(wrapper, node);
////        setTag(wrapper, node);
////        return wrapper;
////    }
