...
@Slf4j
@Component
@SysProtocol(name = "ModbusTcpOverRtu协议", protocolCode = SYDHConstant.PROTOCOL.ModbusTcpOverRtu, description = "系统内置ModbusTcp解析协议")
...
//            }
            ...
            switch (modbusCode) {
                ...
                case Write05:
                    ...
                    report.setSources(hexDump);
                    report.setProtocolCode(SYDHConstant.PROTOCOL.ModbusTcpOverRtu);
...
//                    i -= 1;
    ...
    private OldModbusValue getCacheModbusAddress(String serialNumber, int transactionIdentifier) {
        ...
        // 取其实寄存器地址
        modbusValue.setRegister(Integer.parseInt(sourceData.substring(17, 20), 16));
        // 取寄存器数量
        modbusValue.setIoCount(Integer.parseInt(sourceData.substring(21, 24), 16));
        return modbusValue;
    }
