package com.sydh.ota.test;


import com.sydh.ota.codec.OtaPackageDecoder;
import com.sydh.ota.codec.OtaPackageEncoder;
...
public class OtaPackageProtocolTest {
    ...
    private static OtaPackageDecoder decoder = new OtaPackageDecoder("com.sydh.ota");
    private static OtaPackageEncoder encoder = new OtaPackageEncoder("com.sydh.ota");
