...
//        // 确保key不为null，如果为null则使用默认key
//        final String finalKey;
//        if (key == null || key.trim().isEmpty()) {
//            finalKey = "default:" + System.currentTimeMillis();
//            log.warn("消息key为空，使用默认key: {}", finalKey);
//        } else {
//            finalKey = key;
//        }
//
//        ListenableFuture<SendResult<String, String>> future = kafkaTemplate.send(topic, finalKey, message);
//
//        future.addCallback(new ListenableFutureCallback<SendResult<String, String>>() {
//            @Override
//            public void onSuccess(SendResult<String, String> result) {
//                log.debug("{}消息发送成功 - Topic: {}, Key: {}, Partition: {}, Offset: {}",
//                    description, topic, finalKey,
...
//                    description, topic, finalKey, ex.getMessage(), ex);
//            }
//        });
//    }
//
