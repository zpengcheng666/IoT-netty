    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        ...
        httpSecurity
                ...
                .antMatchers("/login", "/register", "/captchaImage","/iot/tool/register","/iot/tool/ntp",
                        ...
                        "/notify/smsForgetPassword","/system/user/forgetPwdReset", "/system/config/configKey/**").permitAll()
                ...
                // knife4j增强文档
                .antMatchers("/doc.html", "/v2/api-docs", "/v3/api-docs", "/swagger-ui/**", "/favicon.ico").permitAll()
                // oauth2
                ...
                .antMatchers("/httptest/**").permitAll()

                .antMatchers("/ruleview/**").permitAll()
                // 除上面外的所有请求全部需要鉴权认证
