...
public class RedissonProperties {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RedissonProperties)) return false;
        RedissonProperties other = (RedissonProperties) o;
        if (!other.canEqual(this)) return false;
        if (getThreads() != other.getThreads()) return false;
        if (getNettyThreads() != other.getNettyThreads()) return false;
    ...
    public static class SingleServerConfig {
        ...
        public boolean equals(Object o) {
            if (o == this) return true;
            if (!(o instanceof SingleServerConfig)) return false;
            SingleServerConfig other = (SingleServerConfig) o;
            if (!other.canEqual(this)) return false;
            if (getConnectionMinimumIdleSize() != other.getConnectionMinimumIdleSize()) return false;
            if (getConnectionPoolSize() != other.getConnectionPoolSize()) return false;
            if (getIdleConnectionTimeout() != other.getIdleConnectionTimeout()) return false;
            if (getTimeout() != other.getTimeout()) return false;
            if (getSubscriptionConnectionPoolSize() != other.getSubscriptionConnectionPoolSize()) return false;
    ...
    public static class ClusterServersConfig {
        ...
        public boolean equals(Object o) {
            if (o == this) return true;
            if (!(o instanceof ClusterServersConfig)) return false;
            ClusterServersConfig other = (ClusterServersConfig) o;
            if (!other.canEqual(this)) return false;
            if (getMasterConnectionMinimumIdleSize() != other.getMasterConnectionMinimumIdleSize()) return false;
            if (getMasterConnectionPoolSize() != other.getMasterConnectionPoolSize()) return false;
            if (getSlaveConnectionMinimumIdleSize() != other.getSlaveConnectionMinimumIdleSize()) return false;
            if (getSlaveConnectionPoolSize() != other.getSlaveConnectionPoolSize()) return false;
            if (getIdleConnectionTimeout() != other.getIdleConnectionTimeout()) return false;
            if (getTimeout() != other.getTimeout()) return false;
            if (getSubscriptionConnectionPoolSize() != other.getSubscriptionConnectionPoolSize()) return false;
            Object this$clientName = getClientName(), other$clientName = other.getClientName();
...
/* Location:              D:\repository\fastbee-framework\fastbee-framework-2.6.0.jar!\com\fastbee\framework\config\properties\RedissonProperties.class
