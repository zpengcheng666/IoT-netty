...
public class PubMqttClient {
    ...
    public final String getClientId() {
        return SYDHConstant.SERVER.WM_PREFIX + System.currentTimeMillis();
    }
    ...
    public void publish(int qos, boolean retained, String topic, String pushMessage) {
        redisCache.incr2(SYDHConstant.REDIS.MESSAGE_SEND_TOTAL, -1L);
        redisCache.incr2(SYDHConstant.REDIS.MESSAGE_SEND_TODAY, 60 * 60 * 24);
